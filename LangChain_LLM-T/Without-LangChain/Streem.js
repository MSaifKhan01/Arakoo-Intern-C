...
async function makeRequest(prompt, input) {
  ...
  // console.log("init", initialResponse);
  ...
  //   // console.log("initialResult", initialResult.choices[0].message.content);

  //   const generatedText = initialResult.choices[0].text;

  //   // console.log(generatedText);

  //   while (initialResult.choices[0].finish_reason !== "stop") {
  //     await new Promise((resolve) => setTimeout(resolve, 5000));

  //     const subsequentResponse = await fetch(openaiEndpoint, {
  //       method: "POST",
  //       headers: headers,
  //       body: JSON.stringify({ model: "davinci-codex" }),
  //     });

  //     const subsequentResult = await subsequentResponse.json();
  //     const newText = subsequentResult.choices[1].text;

  //     // console.log(newText);
  //   }
  // } else {
  //   console.error(
  //     `Error: ${initialResponse.status} - ${initialResponse.statusText}`
  //   );
  // }
}
